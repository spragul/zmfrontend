 ...
 let valueId = sessionStorage.getItem('value');
  ...
  useEffect(() => {
    axios.get(`${mainurl}/authenticated/${valueId}`).then((response) => {
      ...
      myData.current = response.data.data;
  ...
  function createInstantMeeting() {
    axios.get(`${mainurl}/api/join`).then((response) => {
        ...
        <DialogActions>
          <Button
            ...
            onClick={() => {
              ...
              } else alert("Metting Name cannot be empty!");
            }}
            color="primary"
            variant="contained"
          >
              ...
              <ListSubheader component="div" id="nested-list-subheader">
                <Box>
                  <Grid container>
                    ...
                    <Grid xs={3}>
                      <Tooltip title="Create New Metting">
                        <IconButton
                          onClick={() => {
                            setMeetingName("");
          ...
          <Box height="58vh" style={{ backgroundColor: "white", position: "relative", paddingTop: "8vh" }}>
            ...
            {prevMeetings.length === 0 && (
              <Box style={{ padding: "10vh 1vw", textAlign: "center" }}>
                <Typography variant="h4">Create Your First Metting And Engage with your Colleagues</Typography>
